...
public class CustomerResource {
    ...
    public Customer findById(@PathParam("id") Long id) {
        return customerRepository.findCustomerById(id).orElseThrow(NotFoundException::new);
    }
    ...
    public Response update(Customer customer, @PathParam("id") Long id) {
        ...
        customer.setId(id);
        return Response.ok().entity(customerRepository.saveCustomer(customer)).build();
    }
